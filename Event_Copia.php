...
<?php
	...
	if ($id > 0)
	{
		$sql="INSERT INTO EVENT(NOM,DATA,TIPUS,ESTAT,EVENT_PARE_ID,ESPLANTILLA,CONTADOR,HASHTAG,TEMPORADA,MAX_PARTICIPANTS,MAX_ACOMPANYANTS)
		SELECT CONCAT('Copia de ',NOM),DATA,TIPUS,ESTAT,EVENT_PARE_ID,ESPLANTILLA,CONTADOR,HASHTAG,TEMPORADA,MAX_PARTICIPANTS,MAX_ACOMPANYANTS
