...
function myDblClick(e) 
{
	...
	else
	{
		...
		var width = parseInt(document.getElementById("posicioW").value);
		var height = parseInt(document.getElementById("posicioH").value);
		var angle = parseInt(document.getElementById("posicioangle").value);
		var forma = parseInt(document.getElementById("forma").value);
		var cordo = parseInt(document.getElementById("posiciocordo").value);
		var posicio = parseInt(document.getElementById("posicioC").value);
