...
if ($plantillaid > 0)
{
	$sql="INSERT INTO CASTELL(NOM,EVENT_ID,W,H,PESTANYA_1,PESTANYA_2,PESTANYA_3,PESTANYA_4, ORDRE) 
	SELECT NOM,".$eventid.",W,H,PESTANYA_1,PESTANYA_2,PESTANYA_3,PESTANYA_4,
	(SELECT COUNT(*)+1 FROM CASTELL WHERE EVENT_ID=".$eventid.") AS ORDRE
	FROM PLANTILLA
...
else if (mysqli_query($conn, $sql)) 
{
	...
	if ($plantillaid > 0)
	{
		$sql="INSERT INTO CASTELL_POSICIO(CASTELL_ID,CASELLA_ID,PESTANYA,POSICIO_ID,CORDO,X,Y,H,W,ANGLE,FORMA,TEXT,LINKAT,SEGUENT) 
		SELECT ".$castellId.",CASELLA_ID,PESTANYA,POSICIO_ID,CORDO,X,Y,H,W,ANGLE,FORMA,TEXT,LINKAT,SEGUENT
