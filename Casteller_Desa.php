...
{
	$sql="INSERT INTO CASTELLER(MALNOM, NOM, COGNOM_1, COGNOM_2, POSICIO_PINYA_ID, POSICIO_TRONC_ID, CODI, FAMILIA_ID, FAMILIA2_ID, ESTAT, ALTURA, FORCA, LESIONAT, PORTAR_PEU, NOVELL) 
	VALUES('".$malnom."','".$nom."','".$cognom1."','".$cognom2."',".$posicioPinya.",".$posicioTronc.", UUID(),".$responsable1.",".$responsable2.",1,".$altura.",".$forca.",".$lesionat.",".$portarpeu.",".$novell.")";
}
